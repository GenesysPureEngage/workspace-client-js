...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApplicationApi.Parameters15 = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.VoicecallsiddeletefromconferenceData);
  }
   ...
   * @module model/Parameters15
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Parameters15</code>.
   * @alias module:model/Parameters15
   * @class
   */
   ...
   * @param {module:model/Parameters15} obj Optional instance to populate.
   * @return {module:model/Parameters15} The populated <code>Parameters15</code> instance.
   */
