...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApplicationApi.VoicecallsidalternatecallData = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.Kvpair);
  }
   ...
   * @module model/VoicecallsidalternatecallData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidalternatecallData</code>.
   * @alias module:model/VoicecallsidalternatecallData
   * @class
   ...
   * @param {module:model/VoicecallsidalternatecallData} obj Optional instance to populate.
   * @return {module:model/VoicecallsidalternatecallData} The populated <code>VoicecallsidalternatecallData</code> instance.
   */
