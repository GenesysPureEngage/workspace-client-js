...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApplicationApi.VoicedialData = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.Kvpair);
  }
   ...
   * @module model/VoicedialData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicedialData</code>.
   * @alias module:model/VoicedialData
   * @class
   ...
   * @param {module:model/VoicedialData} obj Optional instance to populate.
   * @return {module:model/VoicedialData} The populated <code>VoicedialData</code> instance.
   */
