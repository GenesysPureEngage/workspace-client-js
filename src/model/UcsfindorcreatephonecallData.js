...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApplicationApi.UcsfindorcreatephonecallData = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.Kvpair);
  }
   ...
   * @module model/UcsfindorcreatephonecallData
   * @version 1.0.0
   */
   ...
   * @param {module:model/UcsfindorcreatephonecallData} obj Optional instance to populate.
   * @return {module:model/UcsfindorcreatephonecallData} The populated <code>UcsfindorcreatephonecallData</code> instance.
   */
