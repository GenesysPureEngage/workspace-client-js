...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApplicationApi.VoicecallsidreconnectcallData = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.Kvpair);
  }
   ...
   * @module model/VoicecallsidreconnectcallData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidreconnectcallData</code>.
   * @alias module:model/VoicecallsidreconnectcallData
   * @class
   ...
   * @param {module:model/VoicecallsidreconnectcallData} obj Optional instance to populate.
   * @return {module:model/VoicecallsidreconnectcallData} The populated <code>VoicecallsidreconnectcallData</code> instance.
   */
