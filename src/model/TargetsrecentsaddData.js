...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RecentData', 'model/TargetId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RecentData'), require('./TargetId'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.TargetsrecentsaddData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.RecentData, root.WorkspaceApi.TargetId);
  }
}(this, function(ApiClient, RecentData, TargetId) {
  'use strict';
   ...
   * @class
   * @param target {module:model/TargetId} The recent target
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('target')) {
        obj['target'] = TargetId.constructFromObject(data['target']);
      }
  ...
  /**
   * The recent target
   * @member {module:model/TargetId} target
   */
