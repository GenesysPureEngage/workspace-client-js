...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApplicationApi.VoicecallsidredirectcallData = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.Kvpair);
  }
   ...
   * @module model/VoicecallsidredirectcallData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidredirectcallData</code>.
   * @alias module:model/VoicecallsidredirectcallData
   * @class
   ...
   * @param {module:model/VoicecallsidredirectcallData} obj Optional instance to populate.
   * @return {module:model/VoicecallsidredirectcallData} The populated <code>VoicecallsidredirectcallData</code> instance.
   */
