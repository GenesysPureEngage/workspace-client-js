...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MediachatinteractionsidconsultbyqueueData', 'model/OperationId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MediachatinteractionsidconsultbyqueueData'), require('./OperationId'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.ConsultData1 = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.MediachatinteractionsidconsultbyqueueData, root.WorkspaceApi.OperationId);
  }
}(this, function(ApiClient, MediachatinteractionsidconsultbyqueueData, OperationId) {
  'use strict';
