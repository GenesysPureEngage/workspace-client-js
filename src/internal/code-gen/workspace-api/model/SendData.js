...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MediaemailinteractionsidsendData', 'model/OperationId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MediaemailinteractionsidsendData'), require('./OperationId'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.SendData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.MediaemailinteractionsidsendData, root.WorkspaceApi.OperationId);
  }
}(this, function(ApiClient, MediaemailinteractionsidsendData, OperationId) {
  'use strict';
