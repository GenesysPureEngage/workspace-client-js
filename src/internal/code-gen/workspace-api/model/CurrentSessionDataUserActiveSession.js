...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('agentReserved')) {
        obj['agentReserved'] = ApiClient.convertToType(data['agentReserved'], 'Number');
      }
    }
    return obj;
  }
   ...
   * @member {Number} agentReserved
   */
  exports.prototype['agentReserved'] = undefined;
