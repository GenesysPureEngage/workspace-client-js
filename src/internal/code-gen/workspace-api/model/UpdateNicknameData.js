...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MediachatinteractionsidupdatenicknameData', 'model/OperationId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MediachatinteractionsidupdatenicknameData'), require('./OperationId'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.UpdateNicknameData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.MediachatinteractionsidupdatenicknameData, root.WorkspaceApi.OperationId);
  }
}(this, function(ApiClient, MediachatinteractionsidupdatenicknameData, OperationId) {
  'use strict';
