...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApi.HoldData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.OperationId, root.WorkspaceApi.VoicecallsidanswerData);
  }
  ...
  /**
   * The HoldData model module.
   * @module model/HoldData
   * @version 9.0.000.78.3880
   */

  /**
   * Constructs a new <code>HoldData</code>.
   * @alias module:model/HoldData
   * @class
   */
  ...
  /**
   * Constructs a <code>HoldData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HoldData} obj Optional instance to populate.
   * @return {module:model/HoldData} The populated <code>HoldData</code> instance.
   */
