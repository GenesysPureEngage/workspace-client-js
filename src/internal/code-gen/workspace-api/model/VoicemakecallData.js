...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApi.VoicemakecallData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.Kvpair);
  }
  ...
  /**
   * The VoicemakecallData model module.
   * @module model/VoicemakecallData
  ...
  /**
   * Constructs a <code>VoicemakecallData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VoicemakecallData} obj Optional instance to populate.
   * @return {module:model/VoicemakecallData} The populated <code>VoicemakecallData</code> instance.
   */
