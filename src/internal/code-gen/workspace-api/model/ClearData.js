...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApi.ClearData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.OperationId, root.WorkspaceApi.VoicecallsidanswerData);
  }
  ...
  /**
   * The ClearData model module.
   * @module model/ClearData
   * @version 9.0.000.73.3700
   */

  /**
   * Constructs a new <code>ClearData</code>.
   * @alias module:model/ClearData
   * @class
   */
  ...
  /**
   * Constructs a <code>ClearData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClearData} obj Optional instance to populate.
   * @return {module:model/ClearData} The populated <code>ClearData</code> instance.
   */
