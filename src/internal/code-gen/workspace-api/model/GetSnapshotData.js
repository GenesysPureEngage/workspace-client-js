...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MediamanagementgetsnapshotData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MediamanagementgetsnapshotData'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.GetSnapshotData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.MediamanagementgetsnapshotData);
  }
}(this, function(ApiClient, MediamanagementgetsnapshotData) {
  'use strict';
