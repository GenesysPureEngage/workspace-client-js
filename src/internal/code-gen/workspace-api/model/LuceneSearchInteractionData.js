...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OperationId', 'model/UcsinteractionssearchData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OperationId'), require('./UcsinteractionssearchData'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.LuceneSearchInteractionData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.OperationId, root.WorkspaceApi.UcsinteractionssearchData);
  }
}(this, function(ApiClient, OperationId, UcsinteractionssearchData) {
  'use strict';
   ...
   * @class
   * @param data {module:model/UcsinteractionssearchData} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = UcsinteractionssearchData.constructFromObject(data['data']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/UcsinteractionssearchData} data
   */
