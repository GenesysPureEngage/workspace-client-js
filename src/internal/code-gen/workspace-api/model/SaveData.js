...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MediaemailinteractionsidsaveData', 'model/OperationId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MediaemailinteractionsidsaveData'), require('./OperationId'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.SaveData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.MediaemailinteractionsidsaveData, root.WorkspaceApi.OperationId);
  }
}(this, function(ApiClient, MediaemailinteractionsidsaveData, OperationId) {
  'use strict';
