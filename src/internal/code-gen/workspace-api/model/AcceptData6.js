...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApi.AcceptData6 = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.MediamediatypeinteractionsidacceptData, root.WorkspaceApi.OperationId);
  }
  ...
  /**
   * The AcceptData6 model module.
   * @module model/AcceptData6
   * @version 9.0.000.40.2832
   */

  /**
   * Constructs a new <code>AcceptData6</code>.
   * @alias module:model/AcceptData6
   * @class
   */
  ...
  /**
   * Constructs a <code>AcceptData6</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AcceptData6} obj Optional instance to populate.
   * @return {module:model/AcceptData6} The populated <code>AcceptData6</code> instance.
   */
