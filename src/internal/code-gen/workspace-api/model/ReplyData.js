...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MediaemailinteractionsidreplyData', 'model/OperationId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MediaemailinteractionsidreplyData'), require('./OperationId'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.ReplyData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.MediaemailinteractionsidreplyData, root.WorkspaceApi.OperationId);
  }
}(this, function(ApiClient, MediaemailinteractionsidreplyData, OperationId) {
  'use strict';
