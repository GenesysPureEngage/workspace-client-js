...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AcceptData5', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/CancelData', 'model/CreateData', 'model/ForwardData1', 'model/ReplyData', 'model/SaveData', 'model/SendData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AcceptData5'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/CancelData'), require('../model/CreateData'), require('../model/ForwardData1'), require('../model/ReplyData'), require('../model/SaveData'), require('../model/SendData'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.EmailApi = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.AcceptData5, root.WorkspaceApi.ApiErrorResponse, root.WorkspaceApi.ApiSuccessResponse, root.WorkspaceApi.CancelData, root.WorkspaceApi.CreateData, root.WorkspaceApi.ForwardData1, root.WorkspaceApi.ReplyData, root.WorkspaceApi.SaveData, root.WorkspaceApi.SendData);
  }
}(this, function(ApiClient, AcceptData5, ApiErrorResponse, ApiSuccessResponse, CancelData, CreateData, ForwardData1, ReplyData, SaveData, SendData) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CancelData} opts.cancelData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.cancelEmailWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['cancelData'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.cancelEmail = function(id, opts) {
      return this.cancelEmailWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
