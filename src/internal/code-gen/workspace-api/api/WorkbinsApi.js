...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddInteractionToWorkbinData', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/CancelConsultData1', 'model/GetDetailsData', 'model/GetWorkbinContentData', 'model/GetWorkbinsContentData', 'model/SubscribeToWorkbinNotificationsData', 'model/SubscribeToWorkbinsNotificationsData', 'model/UnsubscribeToWorkbinNotificationsData', 'model/UnsubscribeToWorkbinsNotificationsData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AddInteractionToWorkbinData'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/CancelConsultData1'), require('../model/GetDetailsData'), require('../model/GetWorkbinContentData'), require('../model/GetWorkbinsContentData'), require('../model/SubscribeToWorkbinNotificationsData'), require('../model/SubscribeToWorkbinsNotificationsData'), require('../model/UnsubscribeToWorkbinNotificationsData'), require('../model/UnsubscribeToWorkbinsNotificationsData'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.WorkbinsApi = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.AddInteractionToWorkbinData, root.WorkspaceApi.ApiErrorResponse, root.WorkspaceApi.ApiSuccessResponse, root.WorkspaceApi.CancelConsultData1, root.WorkspaceApi.GetDetailsData, root.WorkspaceApi.GetWorkbinContentData, root.WorkspaceApi.GetWorkbinsContentData, root.WorkspaceApi.SubscribeToWorkbinNotificationsData, root.WorkspaceApi.SubscribeToWorkbinsNotificationsData, root.WorkspaceApi.UnsubscribeToWorkbinNotificationsData, root.WorkspaceApi.UnsubscribeToWorkbinsNotificationsData);
  }
}(this, function(ApiClient, AddInteractionToWorkbinData, ApiErrorResponse, ApiSuccessResponse, CancelConsultData1, GetDetailsData, GetWorkbinContentData, GetWorkbinsContentData, SubscribeToWorkbinNotificationsData, SubscribeToWorkbinsNotificationsData, UnsubscribeToWorkbinNotificationsData, UnsubscribeToWorkbinsNotificationsData) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/GetDetailsData} opts.getDetailsData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.getInteractionDetailsFromWorkbinWithHttpInfo = function(interactionId, opts) {
      opts = opts || {};
      var postBody = opts['getDetailsData'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.getInteractionDetailsFromWorkbin = function(interactionId, opts) {
      return this.getInteractionDetailsFromWorkbinWithHttpInfo(interactionId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CancelConsultData1} opts.cancelConsultData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.getWorkbinsWithHttpInfo = function(opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.getWorkbins = function(opts) {
      return this.getWorkbinsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
