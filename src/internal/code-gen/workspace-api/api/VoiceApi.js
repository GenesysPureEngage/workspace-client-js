...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AlternateData', 'model/AnswerData', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/CancelForwardBody', 'model/ClearData', 'model/CompleteConferenceData', 'model/CompleteTransferData', 'model/DeleteFromConferenceData', 'model/DndOffBody', 'model/DndOnBody', 'model/DndOnBody1', 'model/ForwardData', 'model/HoldData', 'model/InitiateConferenceData', 'model/InitiateTransferData', 'model/InlineResponse200', 'model/KeyData', 'model/LoginData', 'model/MakeCallData', 'model/MergeData', 'model/MonitoringScopeData', 'model/NotReadyData', 'model/PauseRecordingBody', 'model/ReadyData', 'model/ReconnectData', 'model/RedirectData', 'model/ReleaseData', 'model/ResumeRecordingBody', 'model/RetrieveData', 'model/SendDTMFData', 'model/SendUserEventData', 'model/SetFocusTimeData', 'model/SingleStepConferenceData', 'model/SingleStepTransferData', 'model/StartMonitoringData', 'model/StartRecordingBody', 'model/StopMonitoringData', 'model/StopRecordingBody', 'model/UserData', 'model/UserDataOperationId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AlternateData'), require('../model/AnswerData'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/CancelForwardBody'), require('../model/ClearData'), require('../model/CompleteConferenceData'), require('../model/CompleteTransferData'), require('../model/DeleteFromConferenceData'), require('../model/DndOffBody'), require('../model/DndOnBody'), require('../model/DndOnBody1'), require('../model/ForwardData'), require('../model/HoldData'), require('../model/InitiateConferenceData'), require('../model/InitiateTransferData'), require('../model/InlineResponse200'), require('../model/KeyData'), require('../model/LoginData'), require('../model/MakeCallData'), require('../model/MergeData'), require('../model/MonitoringScopeData'), require('../model/NotReadyData'), require('../model/PauseRecordingBody'), require('../model/ReadyData'), require('../model/ReconnectData'), require('../model/RedirectData'), require('../model/ReleaseData'), require('../model/ResumeRecordingBody'), require('../model/RetrieveData'), require('../model/SendDTMFData'), require('../model/SendUserEventData'), require('../model/SetFocusTimeData'), require('../model/SingleStepConferenceData'), require('../model/SingleStepTransferData'), require('../model/StartMonitoringData'), require('../model/StartRecordingBody'), require('../model/StopMonitoringData'), require('../model/StopRecordingBody'), require('../model/UserData'), require('../model/UserDataOperationId'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.VoiceApi = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.AlternateData, root.WorkspaceApi.AnswerData, root.WorkspaceApi.ApiErrorResponse, root.WorkspaceApi.ApiSuccessResponse, root.WorkspaceApi.CancelForwardBody, root.WorkspaceApi.ClearData, root.WorkspaceApi.CompleteConferenceData, root.WorkspaceApi.CompleteTransferData, root.WorkspaceApi.DeleteFromConferenceData, root.WorkspaceApi.DndOffBody, root.WorkspaceApi.DndOnBody, root.WorkspaceApi.DndOnBody1, root.WorkspaceApi.ForwardData, root.WorkspaceApi.HoldData, root.WorkspaceApi.InitiateConferenceData, root.WorkspaceApi.InitiateTransferData, root.WorkspaceApi.InlineResponse200, root.WorkspaceApi.KeyData, root.WorkspaceApi.LoginData, root.WorkspaceApi.MakeCallData, root.WorkspaceApi.MergeData, root.WorkspaceApi.MonitoringScopeData, root.WorkspaceApi.NotReadyData, root.WorkspaceApi.PauseRecordingBody, root.WorkspaceApi.ReadyData, root.WorkspaceApi.ReconnectData, root.WorkspaceApi.RedirectData, root.WorkspaceApi.ReleaseData, root.WorkspaceApi.ResumeRecordingBody, root.WorkspaceApi.RetrieveData, root.WorkspaceApi.SendDTMFData, root.WorkspaceApi.SendUserEventData, root.WorkspaceApi.SetFocusTimeData, root.WorkspaceApi.SingleStepConferenceData, root.WorkspaceApi.SingleStepTransferData, root.WorkspaceApi.StartMonitoringData, root.WorkspaceApi.StartRecordingBody, root.WorkspaceApi.StopMonitoringData, root.WorkspaceApi.StopRecordingBody, root.WorkspaceApi.UserData, root.WorkspaceApi.UserDataOperationId);
  }
}(this, function(ApiClient, AlternateData, AnswerData, ApiErrorResponse, ApiSuccessResponse, CancelForwardBody, ClearData, CompleteConferenceData, CompleteTransferData, DeleteFromConferenceData, DndOffBody, DndOnBody, DndOnBody1, ForwardData, HoldData, InitiateConferenceData, InitiateTransferData, InlineResponse200, KeyData, LoginData, MakeCallData, MergeData, MonitoringScopeData, NotReadyData, PauseRecordingBody, ReadyData, ReconnectData, RedirectData, ReleaseData, ResumeRecordingBody, RetrieveData, SendDTMFData, SendUserEventData, SetFocusTimeData, SingleStepConferenceData, SingleStepTransferData, StartMonitoringData, StartRecordingBody, StopMonitoringData, StopRecordingBody, UserData, UserDataOperationId) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} id The connection ID of the call.
     * @param {module:model/UserDataOperationId} userData The data to attach to the call. This is an array of objects with the properties key, type, and value.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CancelForwardBody} opts.cancelForwardBody Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.cancelForwardWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['cancelForwardBody'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.cancelForward = function(opts) {
      return this.cancelForwardWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} id The connection ID of the call.
     * @param {module:model/UserData} userData Key/value data to include with the call.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/LoginData} opts.loginData 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.loginVoiceWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['loginData'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.loginVoice = function(opts) {
      return this.loginVoiceWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/DndOnBody} opts.dndOnBody Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.logoutVoiceWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['dndOnBody'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.logoutVoice = function(opts) {
      return this.logoutVoiceWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} id The connection ID of the call.
     * @param {Object} opts Optional parameters
     * @param {module:model/PauseRecordingBody} opts.pauseRecordingBody Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.pauseRecordingWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['pauseRecordingBody'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.pauseRecording = function(id, opts) {
      return this.pauseRecordingWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} id The connection ID of the call.
     * @param {Object} opts Optional parameters
     * @param {module:model/ResumeRecordingBody} opts.resumeRecordingBody Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.resumeRecordingWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['resumeRecordingBody'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.resumeRecording = function(id, opts) {
      return this.resumeRecordingWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/DndOffBody} opts.dndOffBody Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.setDNDOffWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['dndOffBody'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.setDNDOff = function(opts) {
      return this.setDNDOffWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/DndOnBody1} opts.dndOnBody Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.setDNDOnWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['dndOnBody'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.setDNDOn = function(opts) {
      return this.setDNDOnWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} id The connection ID of the call.
     * @param {module:model/SetFocusTimeData} setFocusTimeData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.setFocusTimeCallWithHttpInfo = function(id, setFocusTimeData) {
      var postBody = setFocusTimeData;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling setFocusTimeCall");
      }

      // verify the required parameter 'setFocusTimeData' is set
      if (setFocusTimeData === undefined || setFocusTimeData === null) {
        throw new Error("Missing the required parameter 'setFocusTimeData' when calling setFocusTimeCall");
      }
      ...
      return this.apiClient.callApi(
        '/voice/calls/{id}/set-focus-time', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.setFocusTimeCall = function(id, setFocusTimeData) {
      return this.setFocusTimeCallWithHttpInfo(id, setFocusTimeData)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} id The connection ID of the call.
     * @param {Object} opts Optional parameters
     * @param {module:model/StartRecordingBody} opts.startRecordingBody Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.startRecordingWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['startRecordingBody'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.startRecording = function(id, opts) {
      return this.startRecordingWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} id The connection ID of the call.
     * @param {Object} opts Optional parameters
     * @param {module:model/StopRecordingBody} opts.stopRecordingBody Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.stopRecordingWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['stopRecordingBody'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.stopRecording = function(id, opts) {
      return this.stopRecordingWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
