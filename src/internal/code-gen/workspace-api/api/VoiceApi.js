...
}(this, function(ApiClient, AlternateData, AnswerData, ApiErrorResponse, ApiSuccessResponse, CancelForwardBody, ClearData, CompleteConferenceData, CompleteTransferData, DeleteFromConferenceData, DndOffBody, DndOnBody, DndOnBody1, ForwardData, HoldData, InitiateConferenceData, InitiateTransferData, KeyData, LoginData, MakeCallData, MergeData, MonitoringScopeData, NotReadyData, PauseRecordingBody, ReadyData, ReconnectData, RedirectData, ReleaseData, ResumeRecordingBody, RetrieveData, SendDTMFData, SendUserEventData, SingleStepConferenceData, SingleStepTransferData, StartMonitoringData, StartRecordingBody, StopMonitoringData, StopRecordingBody, UserData, UserDataOperationId) {
  'use strict';
