...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AcceptData', 'model/AcceptData1', 'model/AcceptData2', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/CancelConsultData', 'model/ConsultData', 'model/ConsultData1', 'model/CustomNotificationData', 'model/InviteData', 'model/InviteData1', 'model/LeaveData', 'model/RemoveFromConferenceData', 'model/TypingStartedData', 'model/TypingStoppedData', 'model/UpdateNicknameData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AcceptData'), require('../model/AcceptData1'), require('../model/AcceptData2'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/CancelConsultData'), require('../model/ConsultData'), require('../model/ConsultData1'), require('../model/CustomNotificationData'), require('../model/InviteData'), require('../model/InviteData1'), require('../model/LeaveData'), require('../model/RemoveFromConferenceData'), require('../model/TypingStartedData'), require('../model/TypingStoppedData'), require('../model/UpdateNicknameData'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.ChatApi = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.AcceptData, root.WorkspaceApi.AcceptData1, root.WorkspaceApi.AcceptData2, root.WorkspaceApi.ApiErrorResponse, root.WorkspaceApi.ApiSuccessResponse, root.WorkspaceApi.CancelConsultData, root.WorkspaceApi.ConsultData, root.WorkspaceApi.ConsultData1, root.WorkspaceApi.CustomNotificationData, root.WorkspaceApi.InviteData, root.WorkspaceApi.InviteData1, root.WorkspaceApi.LeaveData, root.WorkspaceApi.RemoveFromConferenceData, root.WorkspaceApi.TypingStartedData, root.WorkspaceApi.TypingStoppedData, root.WorkspaceApi.UpdateNicknameData);
  }
}(this, function(ApiClient, AcceptData, AcceptData1, AcceptData2, ApiErrorResponse, ApiSuccessResponse, CancelConsultData, ConsultData, ConsultData1, CustomNotificationData, InviteData, InviteData1, LeaveData, RemoveFromConferenceData, TypingStartedData, TypingStoppedData, UpdateNicknameData) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CancelConsultData} opts.cancelConsultData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.cancelConsultationChatWithHttpInfo = function(id, mediatype, opts) {
      opts = opts || {};
      var postBody = opts['cancelConsultData'];
      ...
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling cancelConsultationChat");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/cancel-consult', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.cancelConsultationChat = function(id, mediatype, opts) {
      return this.cancelConsultationChatWithHttpInfo(id, mediatype, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    this.chatMessagesWithHttpInfo = function(mediatype, id) {
      var postBody = null;

      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling chatMessages");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/messages', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     */
    this.chatMessages = function(mediatype, id) {
      return this.chatMessagesWithHttpInfo(mediatype, id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.consultWithHttpInfo = function(id, mediatype, consultData) {
      ...
      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling consult");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/consult', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.consult = function(id, mediatype, consultData) {
      return this.consultWithHttpInfo(id, mediatype, consultData)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.consultByQueueWithHttpInfo = function(mediatype, id, consultData) {
      var postBody = consultData;

      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling consultByQueue");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/consult-by-queue', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.consultByQueue = function(mediatype, id, consultData) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.inviteWithHttpInfo = function(id, mediatype, inviteData) {
      ...
      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling invite");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/invite', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.invite = function(id, mediatype, inviteData) {
      return this.inviteWithHttpInfo(id, mediatype, inviteData)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.inviteByQueueWithHttpInfo = function(id, mediatype, inviteData) {
      var postBody = inviteData;
      ...
      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling inviteByQueue");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/invite-by-queue', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.inviteByQueue = function(id, mediatype, inviteData) {
      return this.inviteByQueueWithHttpInfo(id, mediatype, inviteData)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.leaveChatWithHttpInfo = function(mediatype, id, opts) {
      opts = opts || {};
      var postBody = opts['leaveData'];

      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling leaveChat");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/leave', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.leaveChat = function(mediatype, id, opts) {
      return this.leaveChatWithHttpInfo(mediatype, id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.removeFromConferenceWithHttpInfo = function(id, mediatype, removeFromConferenceData) {
      ...
      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling removeFromConference");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/remove-from-conference', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.removeFromConference = function(id, mediatype, removeFromConferenceData) {
      return this.removeFromConferenceWithHttpInfo(id, mediatype, removeFromConferenceData)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.sendCustomNotificationWithHttpInfo = function(mediatype, id, opts) {
      opts = opts || {};
      var postBody = opts['customNotificationData'];

      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling sendCustomNotification");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/send-custom-notification', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.sendCustomNotification = function(mediatype, id, opts) {
      return this.sendCustomNotificationWithHttpInfo(mediatype, id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.sendMessageWithHttpInfo = function(id, mediatype, opts) {
      opts = opts || {};
      var postBody = opts['acceptData'];
      ...
      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling sendMessage");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/send-message', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.sendMessage = function(id, mediatype, opts) {
      return this.sendMessageWithHttpInfo(id, mediatype, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} mediatype The chat media channel.
     * @param {Object} opts Optional parameters
     * @param {module:model/TypingStartedData} opts.typingStartedData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.sendTypingStartedWithHttpInfo = function(id, mediatype, opts) {
      opts = opts || {};
      var postBody = opts['typingStartedData'];
      ...
      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling sendTypingStarted");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/send-typing-started', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.sendTypingStarted = function(id, mediatype, opts) {
      return this.sendTypingStartedWithHttpInfo(id, mediatype, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} mediatype The chat media channel.
     * @param {Object} opts Optional parameters
     * @param {module:model/TypingStoppedData} opts.typingStoppedData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.sendTypingStoppedWithHttpInfo = function(id, mediatype, opts) {
      opts = opts || {};
      var postBody = opts['typingStoppedData'];
      ...
      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling sendTypingStopped");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/send-typing-stopped', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.sendTypingStopped = function(id, mediatype, opts) {
      return this.sendTypingStoppedWithHttpInfo(id, mediatype, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.sendUrlDataWithHttpInfo = function(id, mediatype, opts) {
      opts = opts || {};
      var postBody = opts['acceptData'];
      ...
      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling sendUrlData");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/send-url', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.sendUrlData = function(id, mediatype, opts) {
      return this.sendUrlDataWithHttpInfo(id, mediatype, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} id The ID of the chat interaction.
     * @param {String} mediatype The chat media channel.
     * @param {module:model/UpdateNicknameData} updateNicknameData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.updateNicknameWithHttpInfo = function(id, mediatype, updateNicknameData) {
      var postBody = updateNicknameData;
      ...
      // verify the required parameter 'mediatype' is set
      if (mediatype === undefined || mediatype === null) {
        throw new Error("Missing the required parameter 'mediatype' when calling updateNickname");
      }

      // verify the required parameter 'updateNicknameData' is set
      if (updateNicknameData === undefined || updateNicknameData === null) {
        throw new Error("Missing the required parameter 'updateNicknameData' when calling updateNickname");
      }
      ...
      return this.apiClient.callApi(
        '/media/{mediatype}/interactions/{id}/update-nickname', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.updateNickname = function(id, mediatype, updateNicknameData) {
      return this.updateNicknameWithHttpInfo(id, mediatype, updateNicknameData)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
