...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AcceptData', 'model/AcceptData1', 'model/AcceptData2', 'model/AcceptData3', 'model/AcceptData4', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/AsyncResumeData', 'model/CancelConsultData', 'model/ConsultData', 'model/ConsultData1', 'model/CustomNotificationData', 'model/InlineResponse2003', 'model/InviteData', 'model/InviteData1', 'model/LeaveData', 'model/RemoveFromConferenceData', 'model/SystemCommandData', 'model/UpdateNicknameData', 'model/UploadData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AcceptData'), require('../model/AcceptData1'), require('../model/AcceptData2'), require('../model/AcceptData3'), require('../model/AcceptData4'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/AsyncResumeData'), require('../model/CancelConsultData'), require('../model/ConsultData'), require('../model/ConsultData1'), require('../model/CustomNotificationData'), require('../model/InlineResponse2003'), require('../model/InviteData'), require('../model/InviteData1'), require('../model/LeaveData'), require('../model/RemoveFromConferenceData'), require('../model/SystemCommandData'), require('../model/UpdateNicknameData'), require('../model/UploadData'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.ChatApi = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.AcceptData, root.WorkspaceApi.AcceptData1, root.WorkspaceApi.AcceptData2, root.WorkspaceApi.AcceptData3, root.WorkspaceApi.AcceptData4, root.WorkspaceApi.ApiErrorResponse, root.WorkspaceApi.ApiSuccessResponse, root.WorkspaceApi.AsyncResumeData, root.WorkspaceApi.CancelConsultData, root.WorkspaceApi.ConsultData, root.WorkspaceApi.ConsultData1, root.WorkspaceApi.CustomNotificationData, root.WorkspaceApi.InlineResponse2003, root.WorkspaceApi.InviteData, root.WorkspaceApi.InviteData1, root.WorkspaceApi.LeaveData, root.WorkspaceApi.RemoveFromConferenceData, root.WorkspaceApi.SystemCommandData, root.WorkspaceApi.UpdateNicknameData, root.WorkspaceApi.UploadData);
  }
}(this, function(ApiClient, AcceptData, AcceptData1, AcceptData2, AcceptData3, AcceptData4, ApiErrorResponse, ApiSuccessResponse, AsyncResumeData, CancelConsultData, ConsultData, ConsultData1, CustomNotificationData, InlineResponse2003, InviteData, InviteData1, LeaveData, RemoveFromConferenceData, SystemCommandData, UpdateNicknameData, UploadData) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} id The ID of the chat interaction.
     * @param {module:model/AsyncResumeData} asyncResumeData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.asyncResumeWithHttpInfo = function(id, asyncResumeData) {
      var postBody = asyncResumeData;
      ...
      if (asyncResumeData === undefined || asyncResumeData === null) {
        throw new Error("Missing the required parameter 'asyncResumeData' when calling asyncResume");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.asyncResume = function(id, asyncResumeData) {
      return this.asyncResumeWithHttpInfo(id, asyncResumeData)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.cancelConsultationChatWithHttpInfo = function(id, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.cancelConsultationChat = function(id, opts) {
      return this.cancelConsultationChatWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} id The ID of the chat interaction.
     * @param {Object} opts Optional parameters
     * @param {module:model/UploadData} opts.uploadData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.uploadFileWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['uploadData'];
      ...
      return this.apiClient.callApi(
        '/media/chat/interactions/{id}/upload-file', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.uploadFile = function(id, opts) {
      return this.uploadFileWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
