...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * Get list of objects describes by type and names
     * @param {module:model/String} type Type of object
     * @param {String} names list of object names seperate by coma.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.getObjectsWithHttpInfo = function(type, names) {
      var postBody = null;

      // verify the required parameter 'type' is set
      if (type === undefined || type === null) {
        throw new Error("Missing the required parameter 'type' when calling getObjects");
      }

      // verify the required parameter 'names' is set
      if (names === undefined || names === null) {
        throw new Error("Missing the required parameter 'names' when calling getObjects");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.getObjects = function(type, names) {
      return this.getObjectsWithHttpInfo(type, names)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
