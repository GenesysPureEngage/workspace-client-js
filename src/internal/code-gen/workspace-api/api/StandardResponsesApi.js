...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddFavoritesData', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/GetCategoryData', 'model/GetFavoritesData', 'model/GetRootCategoriesData', 'model/GetStandardResponseData', 'model/LuceneSearchStandardResponseData', 'model/RemoveAllFavoritesData', 'model/RemoveFavoritesData', 'model/RenderStandardResponseFieldCodesData', 'model/ReportStandareResponseUsageData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AddFavoritesData'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/GetCategoryData'), require('../model/GetFavoritesData'), require('../model/GetRootCategoriesData'), require('../model/GetStandardResponseData'), require('../model/LuceneSearchStandardResponseData'), require('../model/RemoveAllFavoritesData'), require('../model/RemoveFavoritesData'), require('../model/RenderStandardResponseFieldCodesData'), require('../model/ReportStandareResponseUsageData'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.StandardResponsesApi = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.AddFavoritesData, root.WorkspaceApi.ApiErrorResponse, root.WorkspaceApi.ApiSuccessResponse, root.WorkspaceApi.GetCategoryData, root.WorkspaceApi.GetFavoritesData, root.WorkspaceApi.GetRootCategoriesData, root.WorkspaceApi.GetStandardResponseData, root.WorkspaceApi.LuceneSearchStandardResponseData, root.WorkspaceApi.RemoveAllFavoritesData, root.WorkspaceApi.RemoveFavoritesData, root.WorkspaceApi.RenderStandardResponseFieldCodesData, root.WorkspaceApi.ReportStandareResponseUsageData);
  }
}(this, function(ApiClient, AddFavoritesData, ApiErrorResponse, ApiSuccessResponse, GetCategoryData, GetFavoritesData, GetRootCategoriesData, GetStandardResponseData, LuceneSearchStandardResponseData, RemoveAllFavoritesData, RemoveFavoritesData, RenderStandardResponseFieldCodesData, ReportStandareResponseUsageData) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/AddFavoritesData} opts.addFavoritesData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.addStandardResponseFavoriteWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['addFavoritesData'];
     ...
     */
    this.addStandardResponseFavorite = function(id, opts) {
      return this.addStandardResponseFavoriteWithHttpInfo(id, opts)
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/RemoveAllFavoritesData} opts.removeAllFavoritesData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.deleteAllStandardResponseFavoritesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['removeAllFavoritesData'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.deleteAllStandardResponseFavorites = function(opts) {
      return this.deleteAllStandardResponseFavoritesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/RemoveFavoritesData} opts.removeFavoritesData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.deleteStandardResponseFavoriteWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['removeFavoritesData'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.deleteStandardResponseFavorite = function(id, opts) {
      return this.deleteStandardResponseFavoriteWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/GetFavoritesData} opts.getFavoritesData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.getStandardResponseFavoritesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['getFavoritesData'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.getStandardResponseFavorites = function(opts) {
      return this.getStandardResponseFavoritesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
