...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AgentHistoryData', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/AssignInteractionToContactData', 'model/CallCommentData', 'model/CallCompletedData', 'model/ConfigResponse', 'model/ContactDetailsData', 'model/ContactHistoryData', 'model/CreateContactData', 'model/EsSearchInteractionData', 'model/IdentifyContactData', 'model/InteractionDetailsData', 'model/LuceneSearchData', 'model/LuceneSearchInteractionData', 'model/UpdateContactData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AgentHistoryData'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/AssignInteractionToContactData'), require('../model/CallCommentData'), require('../model/CallCompletedData'), require('../model/ConfigResponse'), require('../model/ContactDetailsData'), require('../model/ContactHistoryData'), require('../model/CreateContactData'), require('../model/EsSearchInteractionData'), require('../model/IdentifyContactData'), require('../model/InteractionDetailsData'), require('../model/LuceneSearchData'), require('../model/LuceneSearchInteractionData'), require('../model/UpdateContactData'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.UcsApi = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.AgentHistoryData, root.WorkspaceApi.ApiErrorResponse, root.WorkspaceApi.ApiSuccessResponse, root.WorkspaceApi.AssignInteractionToContactData, root.WorkspaceApi.CallCommentData, root.WorkspaceApi.CallCompletedData, root.WorkspaceApi.ConfigResponse, root.WorkspaceApi.ContactDetailsData, root.WorkspaceApi.ContactHistoryData, root.WorkspaceApi.CreateContactData, root.WorkspaceApi.EsSearchInteractionData, root.WorkspaceApi.IdentifyContactData, root.WorkspaceApi.InteractionDetailsData, root.WorkspaceApi.LuceneSearchData, root.WorkspaceApi.LuceneSearchInteractionData, root.WorkspaceApi.UpdateContactData);
  }
}(this, function(ApiClient, AgentHistoryData, ApiErrorResponse, ApiSuccessResponse, AssignInteractionToContactData, CallCommentData, CallCompletedData, ConfigResponse, ContactDetailsData, ContactHistoryData, CreateContactData, EsSearchInteractionData, IdentifyContactData, InteractionDetailsData, LuceneSearchData, LuceneSearchInteractionData, UpdateContactData) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.setCompletedWithHttpInfo = function(id) {
      var postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.setCompleted = function(id) {
      return this.setCompletedWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
