...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AgentHistoryData', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/AssignInteractionToContactData', 'model/CallCommentData', 'model/CallCompletedData', 'model/CompletedData', 'model/ConfigResponse', 'model/ContactDetailsData', 'model/ContactHistoryData', 'model/CreateContactData', 'model/DeletelData', 'model/EsSearchInteractionData', 'model/FindOrCreateData', 'model/IdentifyContactData', 'model/InteractionDetailsData', 'model/LuceneIndexesData', 'model/LuceneSearchData', 'model/LuceneSearchInteractionData', 'model/UpdateContactData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AgentHistoryData'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/AssignInteractionToContactData'), require('../model/CallCommentData'), require('../model/CallCompletedData'), require('../model/CompletedData'), require('../model/ConfigResponse'), require('../model/ContactDetailsData'), require('../model/ContactHistoryData'), require('../model/CreateContactData'), require('../model/DeletelData'), require('../model/EsSearchInteractionData'), require('../model/FindOrCreateData'), require('../model/IdentifyContactData'), require('../model/InteractionDetailsData'), require('../model/LuceneIndexesData'), require('../model/LuceneSearchData'), require('../model/LuceneSearchInteractionData'), require('../model/UpdateContactData'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApi) {
      root.WorkspaceApi = {};
    }
    root.WorkspaceApi.UcsApi = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.AgentHistoryData, root.WorkspaceApi.ApiErrorResponse, root.WorkspaceApi.ApiSuccessResponse, root.WorkspaceApi.AssignInteractionToContactData, root.WorkspaceApi.CallCommentData, root.WorkspaceApi.CallCompletedData, root.WorkspaceApi.CompletedData, root.WorkspaceApi.ConfigResponse, root.WorkspaceApi.ContactDetailsData, root.WorkspaceApi.ContactHistoryData, root.WorkspaceApi.CreateContactData, root.WorkspaceApi.DeletelData, root.WorkspaceApi.EsSearchInteractionData, root.WorkspaceApi.FindOrCreateData, root.WorkspaceApi.IdentifyContactData, root.WorkspaceApi.InteractionDetailsData, root.WorkspaceApi.LuceneIndexesData, root.WorkspaceApi.LuceneSearchData, root.WorkspaceApi.LuceneSearchInteractionData, root.WorkspaceApi.UpdateContactData);
  }
}(this, function(ApiClient, AgentHistoryData, ApiErrorResponse, ApiSuccessResponse, AssignInteractionToContactData, CallCommentData, CallCompletedData, CompletedData, ConfigResponse, ContactDetailsData, ContactHistoryData, CreateContactData, DeletelData, EsSearchInteractionData, FindOrCreateData, IdentifyContactData, InteractionDetailsData, LuceneIndexesData, LuceneSearchData, LuceneSearchInteractionData, UpdateContactData) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/DeletelData} opts.deletelData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.deleteContactWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['deletelData'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.deleteContact = function(id, opts) {
      return this.deleteContactWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:model/EsSearchInteractionData} esSearchInteractionData 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.elastiscSearchInteractionsWithHttpInfo = function(esSearchInteractionData) {
      var postBody = esSearchInteractionData;

      // verify the required parameter 'esSearchInteractionData' is set
      if (esSearchInteractionData === undefined || esSearchInteractionData === null) {
        throw new Error("Missing the required parameter 'esSearchInteractionData' when calling elastiscSearchInteractions");
      }
      ...
      return this.apiClient.callApi(
        '/ucs/interactions/elastic-search', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.elastiscSearchInteractions = function(esSearchInteractionData) {
      return this.elastiscSearchInteractionsWithHttpInfo(esSearchInteractionData)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/FindOrCreateData} opts.findOrCreateData Request parameters.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.findOrCreatePhoneCallWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['findOrCreateData'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.findOrCreatePhoneCall = function(id, opts) {
      return this.findOrCreatePhoneCallWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/LuceneIndexesData} opts.luceneIndexesData Request parameters.
     ...
     */
    this.getLuceneIndexesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['luceneIndexesData'];
     ...
     */
    this.getLuceneIndexes = function(opts) {
      return this.getLuceneIndexesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    this.setCallCompletedWithHttpInfo = function(id, callCompletedData) {
      ...
      return this.apiClient.callApi(
        '/ucs/interactions/{id}/set-call-completed', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @param {String} id id of the Interaction
     * @param {Object} opts Optional parameters
     * @param {module:model/CompletedData} opts.completedData 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiSuccessResponse} and HTTP response
     */
    this.setCompletedWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['completedData'];

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling setCompleted");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiSuccessResponse}
     */
    this.setCompleted = function(id, opts) {
      return this.setCompletedWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
