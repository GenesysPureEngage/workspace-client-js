...
(function(root, factory) {
   ...
   * @module workspace/model/CurrentUserDataUserActiveSessionDn
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CurrentUserDataUserActiveSessionDn</code>.
   * @alias module:workspace/model/CurrentUserDataUserActiveSessionDn
   * @class
   */
   ...
   * @param {module:workspace/model/CurrentUserDataUserActiveSessionDn} obj Optional instance to populate.
   * @return {module:workspace/model/CurrentUserDataUserActiveSessionDn} The populated <code>CurrentUserDataUserActiveSessionDn</code> instance.
   */
