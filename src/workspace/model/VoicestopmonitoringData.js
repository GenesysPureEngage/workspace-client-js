...
(function(root, factory) {
   ...
   * @module workspace/model/VoicestopmonitoringData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicestopmonitoringData</code>.
   * @alias module:workspace/model/VoicestopmonitoringData
   * @class
   ...
   * @param {module:workspace/model/VoicestopmonitoringData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicestopmonitoringData} The populated <code>VoicestopmonitoringData</code> instance.
   */
