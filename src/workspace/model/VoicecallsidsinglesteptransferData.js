...
(function(root, factory) {
   ...
   * @module workspace/model/VoicecallsidsinglesteptransferData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidsinglesteptransferData</code>.
   * @alias module:workspace/model/VoicecallsidsinglesteptransferData
   * @class
   ...
   * @param {module:workspace/model/VoicecallsidsinglesteptransferData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicecallsidsinglesteptransferData} The populated <code>VoicecallsidsinglesteptransferData</code> instance.
   */
