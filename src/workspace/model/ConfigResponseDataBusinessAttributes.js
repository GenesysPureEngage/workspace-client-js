...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['workspace/ApiClient', 'workspace/model/ConfigResponseDataValues', 'workspace/model/Kvpair'], factory);
   ...
   * @module workspace/model/ConfigResponseDataBusinessAttributes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ConfigResponseDataBusinessAttributes</code>.
   * @alias module:workspace/model/ConfigResponseDataBusinessAttributes
   * @class
   */
   ...
   * @param {module:workspace/model/ConfigResponseDataBusinessAttributes} obj Optional instance to populate.
   * @return {module:workspace/model/ConfigResponseDataBusinessAttributes} The populated <code>ConfigResponseDataBusinessAttributes</code> instance.
   */
  ...
  /**
   * @member {Array.<module:workspace/model/ConfigResponseDataValues>} values
   */
