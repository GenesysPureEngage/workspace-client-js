...
(function(root, factory) {
   ...
   * @module workspace/model/UcssetcallcompletedData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UcssetcallcompletedData</code>.
   * @alias module:workspace/model/UcssetcallcompletedData
   * @class
   ...
   * @param {module:workspace/model/UcssetcallcompletedData} obj Optional instance to populate.
   * @return {module:workspace/model/UcssetcallcompletedData} The populated <code>UcssetcallcompletedData</code> instance.
   */
