...
(function(root, factory) {
   ...
   * @module workspace/model/InlineResponse200Status
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InlineResponse200Status</code>.
   * @alias module:workspace/model/InlineResponse200Status
   * @class
   */
   ...
   * @param {module:workspace/model/InlineResponse200Status} obj Optional instance to populate.
   * @return {module:workspace/model/InlineResponse200Status} The populated <code>InlineResponse200Status</code> instance.
   */
