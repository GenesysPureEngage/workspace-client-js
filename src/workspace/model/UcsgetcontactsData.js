...
(function(root, factory) {
   ...
   * @module workspace/model/UcsgetcontactsData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UcsgetcontactsData</code>.
   * @alias module:workspace/model/UcsgetcontactsData
   * @class
   ...
   * @param {module:workspace/model/UcsgetcontactsData} obj Optional instance to populate.
   * @return {module:workspace/model/UcsgetcontactsData} The populated <code>UcsgetcontactsData</code> instance.
   */
