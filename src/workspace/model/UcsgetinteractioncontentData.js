...
(function(root, factory) {
   ...
   * @module workspace/model/UcsgetinteractioncontentData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UcsgetinteractioncontentData</code>.
   * @alias module:workspace/model/UcsgetinteractioncontentData
   * @class
   ...
   * @param {module:workspace/model/UcsgetinteractioncontentData} obj Optional instance to populate.
   * @return {module:workspace/model/UcsgetinteractioncontentData} The populated <code>UcsgetinteractioncontentData</code> instance.
   */
