...
(function(root, factory) {
   ...
   * @module workspace/model/UcsgetagenthistoryData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UcsgetagenthistoryData</code>.
   * @alias module:workspace/model/UcsgetagenthistoryData
   * @class
   */
   ...
   * @param {module:workspace/model/UcsgetagenthistoryData} obj Optional instance to populate.
   * @return {module:workspace/model/UcsgetagenthistoryData} The populated <code>UcsgetagenthistoryData</code> instance.
   */
