...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApi.VoicedialData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.Kvpair);
  }
  ...
  /**
   * The VoicedialData model module.
   * @module workspace/model/VoicedialData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicedialData</code>.
   * @alias module:workspace/model/VoicedialData
   * @class
  ...
  /**
   * Constructs a <code>VoicedialData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:workspace/model/VoicedialData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicedialData} The populated <code>VoicedialData</code> instance.
   */
