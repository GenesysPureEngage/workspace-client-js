...
(function(root, factory) {
   ...
   * @module workspace/model/VoicecallsidcompleteconferenceData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidcompleteconferenceData</code>.
   * @alias module:workspace/model/VoicecallsidcompleteconferenceData
   * @class
   ...
   * @param {module:workspace/model/VoicecallsidcompleteconferenceData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicecallsidcompleteconferenceData} The populated <code>VoicecallsidcompleteconferenceData</code> instance.
   */
