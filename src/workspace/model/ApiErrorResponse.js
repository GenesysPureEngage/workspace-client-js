...
(function(root, factory) {
   ...
   * @module workspace/model/ApiErrorResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ApiErrorResponse</code>.
   * @alias module:workspace/model/ApiErrorResponse
   * @class
   */
   ...
   * @param {module:workspace/model/ApiErrorResponse} obj Optional instance to populate.
   * @return {module:workspace/model/ApiErrorResponse} The populated <code>ApiErrorResponse</code> instance.
   */
