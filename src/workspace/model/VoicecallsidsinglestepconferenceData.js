...
(function(root, factory) {
   ...
   * @module workspace/model/VoicecallsidsinglestepconferenceData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidsinglestepconferenceData</code>.
   * @alias module:workspace/model/VoicecallsidsinglestepconferenceData
   * @class
   ...
   * @param {module:workspace/model/VoicecallsidsinglestepconferenceData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicecallsidsinglestepconferenceData} The populated <code>VoicecallsidsinglestepconferenceData</code> instance.
   */
