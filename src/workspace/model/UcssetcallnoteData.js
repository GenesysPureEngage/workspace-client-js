...
(function(root, factory) {
   ...
   * @module workspace/model/UcssetcallnoteData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UcssetcallnoteData</code>.
   * @alias module:workspace/model/UcssetcallnoteData
   * @class
   ...
   * @param {module:workspace/model/UcssetcallnoteData} obj Optional instance to populate.
   * @return {module:workspace/model/UcssetcallnoteData} The populated <code>UcssetcallnoteData</code> instance.
   */
