...
(function(root, factory) {
   ...
   * @module workspace/model/Parameters3
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Parameters3</code>.
   * @alias module:workspace/model/Parameters3
   * @class
   */
   ...
   * @param {module:workspace/model/Parameters3} obj Optional instance to populate.
   * @return {module:workspace/model/Parameters3} The populated <code>Parameters3</code> instance.
   */
