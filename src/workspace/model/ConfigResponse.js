...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['workspace/ApiClient', 'workspace/model/ConfigResponseData', 'workspace/model/InlineResponse200Status'], factory);
   ...
   * @module workspace/model/ConfigResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ConfigResponse</code>.
   * @alias module:workspace/model/ConfigResponse
   * @class
   */
   ...
   * @param {module:workspace/model/ConfigResponse} obj Optional instance to populate.
   * @return {module:workspace/model/ConfigResponse} The populated <code>ConfigResponse</code> instance.
   */
  ...
  /**
   * @member {module:workspace/model/ConfigResponseData} data
   */
