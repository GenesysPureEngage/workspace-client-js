...
(function(root, factory) {
   ...
   * @module workspace/model/UcsgetcontacthistoryData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UcsgetcontacthistoryData</code>.
   * @alias module:workspace/model/UcsgetcontacthistoryData
   * @class
   ...
   * @param {module:workspace/model/UcsgetcontacthistoryData} obj Optional instance to populate.
   * @return {module:workspace/model/UcsgetcontacthistoryData} The populated <code>UcsgetcontacthistoryData</code> instance.
   */
