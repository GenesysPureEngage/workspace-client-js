...
(function(root, factory) {
   ...
   * @module workspace/model/ConfigResponseDataValues
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ConfigResponseDataValues</code>.
   * @alias module:workspace/model/ConfigResponseDataValues
   * @class
   */
   ...
   * @param {module:workspace/model/ConfigResponseDataValues} obj Optional instance to populate.
   * @return {module:workspace/model/ConfigResponseDataValues} The populated <code>ConfigResponseDataValues</code> instance.
   */
