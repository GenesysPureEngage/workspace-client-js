...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['workspace/ApiClient', 'workspace/model/InlineResponse200Status'], factory);
   ...
   * @module workspace/model/ApiSuccessResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ApiSuccessResponse</code>.
   * @alias module:workspace/model/ApiSuccessResponse
   * @class
   */
   ...
   * @param {module:workspace/model/ApiSuccessResponse} obj Optional instance to populate.
   * @return {module:workspace/model/ApiSuccessResponse} The populated <code>ApiSuccessResponse</code> instance.
   */
