...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['workspace/ApiClient', 'workspace/model/Call'], factory);
   ...
   * @module workspace/model/InlineResponse200Data
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InlineResponse200Data</code>.
   * @alias module:workspace/model/InlineResponse200Data
   * @class
   * @param calls {Array.<module:workspace/model/Call>} The list of all the calls.
   */
   ...
   * @param {module:workspace/model/InlineResponse200Data} obj Optional instance to populate.
   * @return {module:workspace/model/InlineResponse200Data} The populated <code>InlineResponse200Data</code> instance.
   */
   ...
   * @member {Array.<module:workspace/model/Call>} calls
   */
