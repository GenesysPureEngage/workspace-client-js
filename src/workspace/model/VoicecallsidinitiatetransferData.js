...
(function(root, factory) {
   ...
   * @module workspace/model/VoicecallsidinitiatetransferData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidinitiatetransferData</code>.
   * @alias module:workspace/model/VoicecallsidinitiatetransferData
   * @class
   * @param destination {String} Directory number of the party to be called.
   */
   ...
   * @param {module:workspace/model/VoicecallsidinitiatetransferData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicecallsidinitiatetransferData} The populated <code>VoicecallsidinitiatetransferData</code> instance.
   */
