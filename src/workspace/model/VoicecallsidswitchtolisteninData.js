...
(function(root, factory) {
   ...
   * @module workspace/model/VoicecallsidswitchtolisteninData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidswitchtolisteninData</code>.
   * @alias module:workspace/model/VoicecallsidswitchtolisteninData
   * @class
   */
   ...
   * @param {module:workspace/model/VoicecallsidswitchtolisteninData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicecallsidswitchtolisteninData} The populated <code>VoicecallsidswitchtolisteninData</code> instance.
   */
   ...
   * @member {module:workspace/model/VoicecallsidswitchtolisteninData.MonitoringScopeEnum} monitoringScope
   */
