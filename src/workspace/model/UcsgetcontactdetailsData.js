...
(function(root, factory) {
   ...
   * @module workspace/model/UcsgetcontactdetailsData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UcsgetcontactdetailsData</code>.
   * @alias module:workspace/model/UcsgetcontactdetailsData
   * @class
   ...
   * @param {module:workspace/model/UcsgetcontactdetailsData} obj Optional instance to populate.
   * @return {module:workspace/model/UcsgetcontactdetailsData} The populated <code>UcsgetcontactdetailsData</code> instance.
   */
