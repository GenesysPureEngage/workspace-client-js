...
(function(root, factory) {
   ...
   * @module workspace/model/ConfigResponseDataTransactions
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ConfigResponseDataTransactions</code>.
   * @alias module:workspace/model/ConfigResponseDataTransactions
   * @class
   */
   ...
   * @param {module:workspace/model/ConfigResponseDataTransactions} obj Optional instance to populate.
   * @return {module:workspace/model/ConfigResponseDataTransactions} The populated <code>ConfigResponseDataTransactions</code> instance.
   */
