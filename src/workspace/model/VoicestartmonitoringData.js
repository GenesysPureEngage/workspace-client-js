...
(function(root, factory) {
   ...
   * @module workspace/model/VoicestartmonitoringData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicestartmonitoringData</code>.
   * @alias module:workspace/model/VoicestartmonitoringData
   * @class
   ...
   * @param {module:workspace/model/VoicestartmonitoringData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicestartmonitoringData} The populated <code>VoicestartmonitoringData</code> instance.
   */
   ...
   * @member {module:workspace/model/VoicestartmonitoringData.MonitoringModeEnum} monitoringMode
   */
  exports.prototype['monitoringMode'] = undefined;
  /**
   * The monitoring call type (NextCall/AllCalls).
   * @member {module:workspace/model/VoicestartmonitoringData.MonitoringNextCallTypeEnum} monitoringNextCallType
   */
  exports.prototype['monitoringNextCallType'] = undefined;
  /**
   * The monitoring scope (Call/Agent).
   * @member {module:workspace/model/VoicestartmonitoringData.MonitoringScopeEnum} monitoringScope
   */
