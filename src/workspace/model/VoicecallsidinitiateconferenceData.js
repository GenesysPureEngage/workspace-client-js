...
(function(root, factory) {
   ...
   * @module workspace/model/VoicecallsidinitiateconferenceData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidinitiateconferenceData</code>.
   * @alias module:workspace/model/VoicecallsidinitiateconferenceData
   * @class
   ...
   * @param {module:workspace/model/VoicecallsidinitiateconferenceData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicecallsidinitiateconferenceData} The populated <code>VoicecallsidinitiateconferenceData</code> instance.
   */
