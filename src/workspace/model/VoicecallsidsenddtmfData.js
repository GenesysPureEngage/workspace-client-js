...
(function(root, factory) {
   ...
   * @module workspace/model/VoicecallsidsenddtmfData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidsenddtmfData</code>.
   * @alias module:workspace/model/VoicecallsidsenddtmfData
   * @class
   ...
   * @param {module:workspace/model/VoicecallsidsenddtmfData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicecallsidsenddtmfData} The populated <code>VoicecallsidsenddtmfData</code> instance.
   */
