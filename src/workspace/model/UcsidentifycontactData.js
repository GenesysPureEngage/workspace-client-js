...
(function(root, factory) {
   ...
   * @module workspace/model/UcsidentifycontactData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UcsidentifycontactData</code>.
   * @alias module:workspace/model/UcsidentifycontactData
   * @class
   ...
   * @param {module:workspace/model/UcsidentifycontactData} obj Optional instance to populate.
   * @return {module:workspace/model/UcsidentifycontactData} The populated <code>UcsidentifycontactData</code> instance.
   */
