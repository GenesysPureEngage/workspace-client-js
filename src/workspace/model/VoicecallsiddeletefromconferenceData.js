...
(function(root, factory) {
   ...
   * @module workspace/model/VoicecallsiddeletefromconferenceData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsiddeletefromconferenceData</code>.
   * @alias module:workspace/model/VoicecallsiddeletefromconferenceData
   * @class
   ...
   * @param {module:workspace/model/VoicecallsiddeletefromconferenceData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicecallsiddeletefromconferenceData} The populated <code>VoicecallsiddeletefromconferenceData</code> instance.
   */
