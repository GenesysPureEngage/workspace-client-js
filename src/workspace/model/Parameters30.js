...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['workspace/ApiClient', 'workspace/model/UcsgetcontactdetailsData'], factory);
   ...
   * @module workspace/model/Parameters30
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Parameters30</code>.
   * @alias module:workspace/model/Parameters30
   * @class
   */
   ...
   * @param {module:workspace/model/Parameters30} obj Optional instance to populate.
   * @return {module:workspace/model/Parameters30} The populated <code>Parameters30</code> instance.
   */
  ...
  /**
   * @member {module:workspace/model/UcsgetcontactdetailsData} data
   */
