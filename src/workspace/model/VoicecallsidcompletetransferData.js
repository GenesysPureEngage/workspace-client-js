...
(function(root, factory) {
   ...
   * @module workspace/model/VoicecallsidcompletetransferData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidcompletetransferData</code>.
   * @alias module:workspace/model/VoicecallsidcompletetransferData
   * @class
   ...
   * @param {module:workspace/model/VoicecallsidcompletetransferData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicecallsidcompletetransferData} The populated <code>VoicecallsidcompletetransferData</code> instance.
   */
