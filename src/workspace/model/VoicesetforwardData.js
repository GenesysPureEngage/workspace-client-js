...
(function(root, factory) {
   ...
   * @module workspace/model/VoicesetforwardData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicesetforwardData</code>.
   * @alias module:workspace/model/VoicesetforwardData
   * @class
   ...
   * @param {module:workspace/model/VoicesetforwardData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicesetforwardData} The populated <code>VoicesetforwardData</code> instance.
   */
