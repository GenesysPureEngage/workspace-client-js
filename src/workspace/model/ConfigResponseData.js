...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['workspace/ApiClient', 'workspace/model/ConfigResponseDataActionCodes', 'workspace/model/ConfigResponseDataBusinessAttributes', 'workspace/model/ConfigResponseDataTransactions'], factory);
   ...
   * @module workspace/model/ConfigResponseData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ConfigResponseData</code>.
   * @alias module:workspace/model/ConfigResponseData
   * @class
   */
   ...
   * @param {module:workspace/model/ConfigResponseData} obj Optional instance to populate.
   * @return {module:workspace/model/ConfigResponseData} The populated <code>ConfigResponseData</code> instance.
   */
  ...
  /**
   * @member {Array.<module:workspace/model/ConfigResponseDataActionCodes>} actionCodes
   */
  exports.prototype['actionCodes'] = undefined;
  /**
   * @member {Array.<module:workspace/model/ConfigResponseDataTransactions>} transactions
   */
  exports.prototype['transactions'] = undefined;
  /**
   * @member {Array.<module:workspace/model/ConfigResponseDataBusinessAttributes>} businessAttributes
   */
