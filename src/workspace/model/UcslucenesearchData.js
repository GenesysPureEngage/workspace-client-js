...
(function(root, factory) {
   ...
   * @module workspace/model/UcslucenesearchData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UcslucenesearchData</code>.
   * @alias module:workspace/model/UcslucenesearchData
   * @class
   ...
   * @param {module:workspace/model/UcslucenesearchData} obj Optional instance to populate.
   * @return {module:workspace/model/UcslucenesearchData} The populated <code>UcslucenesearchData</code> instance.
   */
