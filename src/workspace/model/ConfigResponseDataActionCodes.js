...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApi.ConfigResponseDataActionCodes = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.Kvpair);
  }
   ...
   * @module workspace/model/ConfigResponseDataActionCodes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ConfigResponseDataActionCodes</code>.
   * @alias module:workspace/model/ConfigResponseDataActionCodes
   * @class
   */
   ...
   * @param {module:workspace/model/ConfigResponseDataActionCodes} obj Optional instance to populate.
   * @return {module:workspace/model/ConfigResponseDataActionCodes} The populated <code>ConfigResponseDataActionCodes</code> instance.
   */
