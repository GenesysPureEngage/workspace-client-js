...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApi.VoicecallsidredirectcallData = factory(root.WorkspaceApi.ApiClient, root.WorkspaceApi.Kvpair);
  }
  ...
  /**
   * The VoicecallsidredirectcallData model module.
   * @module workspace/model/VoicecallsidredirectcallData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VoicecallsidredirectcallData</code>.
   * @alias module:workspace/model/VoicecallsidredirectcallData
   * @class
  ...
  /**
   * Constructs a <code>VoicecallsidredirectcallData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:workspace/model/VoicecallsidredirectcallData} obj Optional instance to populate.
   * @return {module:workspace/model/VoicecallsidredirectcallData} The populated <code>VoicecallsidredirectcallData</code> instance.
   */
