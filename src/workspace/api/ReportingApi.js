...
(function(root, factory) {
  ...
  /**
   * Reporting service.
   * @module workspace/api/ReportingApi
   * @version 1.0.0
   */

  /**
   * Constructs a new ReportingApi. 
   * @alias module:workspace/api/ReportingApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:workspace/api/ReportingApi~subscribeCallback
     * @param {String} error Error message, if any.
     * @param {module:workspace/model/ApiSuccessResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:workspace/model/Statistics} statistics Requested Statistics
     * @param {module:workspace/api/ReportingApi~subscribeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:workspace/model/ApiSuccessResponse}
     */
     ...
     * @callback module:workspace/api/ReportingApi~unsubscribeCallback
     * @param {String} error Error message, if any.
     * @param {module:workspace/model/ApiSuccessResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
