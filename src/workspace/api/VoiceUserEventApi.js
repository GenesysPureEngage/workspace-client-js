...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['workspace/ApiClient', 'workspace/model/ApiErrorResponse', 'workspace/model/ApiSuccessResponse', 'workspace/model/UserData2'], factory);
   ...
   * @module workspace/api/VoiceUserEventApi
   * @version 1.0.0
   */

  /**
   * Constructs a new VoiceUserEventApi. 
   * @alias module:workspace/api/VoiceUserEventApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:workspace/api/VoiceUserEventApi~sendUserEventCallback
     ...
     * @param {module:workspace/model/UserData2} userData An array of key/value pairs.
     * @param {module:workspace/api/VoiceUserEventApi~sendUserEventCallback} callback The callback function, accepting three arguments: error, data, response
