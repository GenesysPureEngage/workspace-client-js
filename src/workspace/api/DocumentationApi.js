...
(function(root, factory) {
   ...
   * @module workspace/api/DocumentationApi
   * @version 1.0.0
   */

  /**
   * Constructs a new DocumentationApi. 
   * @alias module:workspace/api/DocumentationApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:workspace/api/DocumentationApi~swaggerDocCallback
     ...
     * Returns API description in Swagger format
     * @param {module:workspace/api/DocumentationApi~swaggerDocCallback} callback The callback function, accepting three arguments: error, data, response
     */
