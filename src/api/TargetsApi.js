...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/Parameters40'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/Parameters40'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApplicationApi) {
      root.WorkspaceApplicationApi = {};
    }
    root.WorkspaceApplicationApi.TargetsApi = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.ApiErrorResponse, root.WorkspaceApplicationApi.ApiSuccessResponse, root.WorkspaceApplicationApi.Parameters40);
  }
}(this, function(ApiClient, ApiErrorResponse, ApiSuccessResponse, Parameters40) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/TargetsApi~targetUnsubscribeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ApiSuccessResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TargetsApi~targetUnsubscribeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ApiSuccessResponse}
     */
