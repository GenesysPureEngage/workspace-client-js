...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/ConfigResponse', 'model/Parameters26', 'model/Parameters27', 'model/Parameters28', 'model/Parameters29', 'model/Parameters30', 'model/Parameters31', 'model/Parameters32', 'model/Parameters33', 'model/Parameters34', 'model/Parameters35', 'model/Parameters36', 'model/Parameters37', 'model/Parameters38', 'model/Parameters39'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/ConfigResponse'), require('../model/Parameters26'), require('../model/Parameters27'), require('../model/Parameters28'), require('../model/Parameters29'), require('../model/Parameters30'), require('../model/Parameters31'), require('../model/Parameters32'), require('../model/Parameters33'), require('../model/Parameters34'), require('../model/Parameters35'), require('../model/Parameters36'), require('../model/Parameters37'), require('../model/Parameters38'), require('../model/Parameters39'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApplicationApi) {
      root.WorkspaceApplicationApi = {};
    }
    root.WorkspaceApplicationApi.UcsApi = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.ApiErrorResponse, root.WorkspaceApplicationApi.ApiSuccessResponse, root.WorkspaceApplicationApi.ConfigResponse, root.WorkspaceApplicationApi.Parameters26, root.WorkspaceApplicationApi.Parameters27, root.WorkspaceApplicationApi.Parameters28, root.WorkspaceApplicationApi.Parameters29, root.WorkspaceApplicationApi.Parameters30, root.WorkspaceApplicationApi.Parameters31, root.WorkspaceApplicationApi.Parameters32, root.WorkspaceApplicationApi.Parameters33, root.WorkspaceApplicationApi.Parameters34, root.WorkspaceApplicationApi.Parameters35, root.WorkspaceApplicationApi.Parameters36, root.WorkspaceApplicationApi.Parameters37, root.WorkspaceApplicationApi.Parameters38, root.WorkspaceApplicationApi.Parameters39);
  }
}(this, function(ApiClient, ApiErrorResponse, ApiSuccessResponse, ConfigResponse, Parameters26, Parameters27, Parameters28, Parameters29, Parameters30, Parameters31, Parameters32, Parameters33, Parameters34, Parameters35, Parameters36, Parameters37, Parameters38, Parameters39) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/Parameters33} opts.parameters 
     ...
     * @param {module:model/Parameters32} parameters 
