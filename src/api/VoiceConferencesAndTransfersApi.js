...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/Parameters10', 'model/Parameters11', 'model/Parameters12', 'model/Parameters13', 'model/Parameters14', 'model/Parameters15', 'model/Parameters9'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/Parameters10'), require('../model/Parameters11'), require('../model/Parameters12'), require('../model/Parameters13'), require('../model/Parameters14'), require('../model/Parameters15'), require('../model/Parameters9'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApplicationApi) {
      root.WorkspaceApplicationApi = {};
    }
    root.WorkspaceApplicationApi.VoiceConferencesAndTransfersApi = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.ApiErrorResponse, root.WorkspaceApplicationApi.ApiSuccessResponse, root.WorkspaceApplicationApi.Parameters10, root.WorkspaceApplicationApi.Parameters11, root.WorkspaceApplicationApi.Parameters12, root.WorkspaceApplicationApi.Parameters13, root.WorkspaceApplicationApi.Parameters14, root.WorkspaceApplicationApi.Parameters15, root.WorkspaceApplicationApi.Parameters9);
  }
}(this, function(ApiClient, ApiErrorResponse, ApiSuccessResponse, Parameters10, Parameters11, Parameters12, Parameters13, Parameters14, Parameters15, Parameters9) {
  'use strict';
