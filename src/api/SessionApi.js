...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiErrorResponse', 'model/ApiSuccessResponse', 'model/ConfigResponse', 'model/CurrentUser', 'model/Parameters', 'model/Parameters1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiErrorResponse'), require('../model/ApiSuccessResponse'), require('../model/ConfigResponse'), require('../model/CurrentUser'), require('../model/Parameters'), require('../model/Parameters1'));
  } else {
    // Browser globals (root is window)
    if (!root.WorkspaceApplicationApi) {
      root.WorkspaceApplicationApi = {};
    }
    root.WorkspaceApplicationApi.SessionApi = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.ApiErrorResponse, root.WorkspaceApplicationApi.ApiSuccessResponse, root.WorkspaceApplicationApi.ConfigResponse, root.WorkspaceApplicationApi.CurrentUser, root.WorkspaceApplicationApi.Parameters, root.WorkspaceApplicationApi.Parameters1);
  }
}(this, function(ApiClient, ApiErrorResponse, ApiSuccessResponse, ConfigResponse, CurrentUser, Parameters, Parameters1) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/Parameters1} parameters 
    ...
    this.login = function(parameters, callback) {
      ...
      // verify the required parameter 'parameters' is set
      if (parameters == undefined || parameters == null) {
        throw new Error("Missing the required parameter 'parameters' when calling login");
      }
    ...
    /**
     * Callback function to receive the result of the userInformation operation.
     * @callback module:api/SessionApi~userInformationCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SessionApi~userInformationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CurrentUser}
     */
    this.userInformation = function(callback) {
      var postBody = null;
