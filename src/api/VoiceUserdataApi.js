...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WorkspaceApplicationApi.VoiceUserdataApi = factory(root.WorkspaceApplicationApi.ApiClient, root.WorkspaceApplicationApi.ApiErrorResponse, root.WorkspaceApplicationApi.ApiSuccessResponse, root.WorkspaceApplicationApi.Key, root.WorkspaceApplicationApi.UserData, root.WorkspaceApplicationApi.UserData1);
  }
   ...
   * @module api/VoiceUserdataApi
   * @version 1.0.0
   */

  /**
   * Constructs a new VoiceUserdataApi. 
   * @alias module:api/VoiceUserdataApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/VoiceUserdataApi~attachUserDataCallback
     ...
     * @param {module:api/VoiceUserdataApi~attachUserDataCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/VoiceUserdataApi~updateUserDataCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ApiSuccessResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
